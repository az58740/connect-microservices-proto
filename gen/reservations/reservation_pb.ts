 ...
 */
export type ProviderServiceDOT = Message<"reservation.ProviderServiceDOT"> & {
  /**
 ...
 */
export const ProviderServiceDOTSchema: GenMessage<ProviderServiceDOT> = /*@__PURE__*/
  messageDesc(file_reservations_reservation, 103);

/**
 * @generated from message reservation.ProviderServiceWithUser
 */
export type ProviderServiceWithUser = Message<"reservation.ProviderServiceWithUser"> & {
  /**
 ...
 */
export const ProviderServiceWithUserSchema: GenMessage<ProviderServiceWithUser> = /*@__PURE__*/
