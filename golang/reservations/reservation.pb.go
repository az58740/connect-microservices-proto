...
func (x *UpdateWeeklyScheduleRequest) GetStartTime() string {
	if x != nil {
		return x.StartTime
	}
	return ""
...
func (x *UpdateWeeklyScheduleRequest) GetEndTime() string {
	if x != nil {
		return x.EndTime
	}
	return ""
...
var file_reservations_reservation_proto_rawDesc = []byte{
	...
	0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x22,
	0xc5, 0x01, 0x0a, 0x14, 0x57, 0x65, 0x65, 0x6b, 0x6c, 0x79, 0x53, 0x63, 0x68, 0x65, 0x64, 0x75,
	...
	0x42, 0x05, 0x0a, 0x03, 0x5f, 0x69, 0x64, 0x22, 0x59, 0x0a, 0x1c, 0x47, 0x65, 0x74, 0x57, 0x65,
	...
	0x79, 0x73, 0x63, 0x68, 0x65, 0x64, 0x75, 0x6c, 0x65, 0x73, 0x22, 0xba, 0x02, 0x0a, 0x1b, 0x55,
	...
	0x57, 0x65, 0x65, 0x6b, 0x44, 0x61, 0x79, 0x52, 0x03, 0x64, 0x61, 0x79, 0x12, 0x1d, 0x0a, 0x0a,
...
var file_reservations_reservation_proto_depIdxs = []int32{
	...
	49,  // 74: reservation.GetWeeklyScheduleListRequest.filter:type_name -> reservation.WeeklyScheduleFilter
	15,  // 75: reservation.GetWeeklyScheduleListResponse.weeklyschedules:type_name -> reservation.WeeklySchedule
	2,   // 76: reservation.UpdateWeeklyScheduleRequest.day:type_name -> reservation.WeekDay
	8,   // 77: reservation.UpdateWeeklyScheduleRequest.status:type_name -> reservation.Status
	15,  // 78: reservation.UpdateWeeklyScheduleResponse.weeklySchedule:type_name -> reservation.WeeklySchedule
	16,  // 79: reservation.GenerateTimeSlotsRequest.timeslot:type_name -> reservation.TimeSlot
	114, // 80: reservation.TimeSlotsFilter.start_time:type_name -> google.protobuf.Timestamp
	114, // 81: reservation.TimeSlotsFilter.end_time:type_name -> google.protobuf.Timestamp
	0,   // 82: reservation.TimeSlotsFilter.owner_type:type_name -> reservation.OwnerType
	2,   // 83: reservation.TimeSlotsFilter.day:type_name -> reservation.WeekDay
	8,   // 84: reservation.TimeSlotsFilter.status:type_name -> reservation.Status
	56,  // 85: reservation.GetTimeSlotsListRequest.filter:type_name -> reservation.TimeSlotsFilter
	16,  // 86: reservation.GetTimeSlotsListResponse.stimeslots:type_name -> reservation.TimeSlot
	114, // 87: reservation.UpdateTimeSlotRequest.start_time:type_name -> google.protobuf.Timestamp
	114, // 88: reservation.UpdateTimeSlotRequest.end_time:type_name -> google.protobuf.Timestamp
	0,   // 89: reservation.UpdateTimeSlotRequest.owner_type:type_name -> reservation.OwnerType
	8,   // 90: reservation.UpdateTimeSlotRequest.status:type_name -> reservation.Status
	16,  // 91: reservation.UpdateTimeSlotResponse.tileslot:type_name -> reservation.TimeSlot
	3,   // 92: reservation.MarkAttendanceRequest.status:type_name -> reservation.AttendanceStatus
	23,  // 93: reservation.ListReservationsResponse.reservations:type_name -> reservation.Reservation
	114, // 94: reservation.ListAvailableTimeSlotsRequest.from:type_name -> google.protobuf.Timestamp
	114, // 95: reservation.ListAvailableTimeSlotsRequest.to:type_name -> google.protobuf.Timestamp
	16,  // 96: reservation.ListAvailableTimeSlotsResponse.time_slots:type_name -> reservation.TimeSlot
	1,   // 97: reservation.UpdateReservationStatusRequest.status:type_name -> reservation.ReservationStatus
	17,  // 98: reservation.CreateProviderUnavailabilityRequest.unavailability:type_name -> reservation.ProviderUnavailability
	114, // 99: reservation.ListProviderUnavailabilityRequest.from:type_name -> google.protobuf.Timestamp
	114, // 100: reservation.ListProviderUnavailabilityRequest.to:type_name -> google.protobuf.Timestamp
	17,  // 101: reservation.ListProviderUnavailabilityResponse.items:type_name -> reservation.ProviderUnavailability
	20,  // 102: reservation.CreateRoomTypeRequest.room_type:type_name -> reservation.RoomType
	20,  // 103: reservation.ListRoomTypesResponse.items:type_name -> reservation.RoomType
	21,  // 104: reservation.CreateRoomRequest.room:type_name -> reservation.Room
	21,  // 105: reservation.ListRoomsResponse.items:type_name -> reservation.Room
	22,  // 106: reservation.AddRoomImageRequest.image:type_name -> reservation.RoomImage
	22,  // 107: reservation.GetRoomImagesResponse.items:type_name -> reservation.RoomImage
	114, // 108: reservation.CheckRoomAvailabilityRequest.from:type_name -> google.protobuf.Timestamp
	114, // 109: reservation.CheckRoomAvailabilityRequest.to:type_name -> google.protobuf.Timestamp
	18,  // 110: reservation.CheckRoomAvailabilityResponse.items:type_name -> reservation.RoomAvailability
	114, // 111: reservation.ListRoomAvailabilityRequest.from:type_name -> google.protobuf.Timestamp
	114, // 112: reservation.ListRoomAvailabilityRequest.to:type_name -> google.protobuf.Timestamp
	18,  // 113: reservation.ListRoomAvailabilityResponse.items:type_name -> reservation.RoomAvailability
	19,  // 114: reservation.CreateServiceUnavailabilityRequest.unavailability:type_name -> reservation.ServiceUnavailability
	114, // 115: reservation.ListServiceUnavailabilityRequest.from:type_name -> google.protobuf.Timestamp
	114, // 116: reservation.ListServiceUnavailabilityRequest.to:type_name -> google.protobuf.Timestamp
	19,  // 117: reservation.ListServiceUnavailabilityResponse.items:type_name -> reservation.ServiceUnavailability
	13,  // 118: reservation.AddFacilityImageRequest.image:type_name -> reservation.FacilityImage
	13,  // 119: reservation.GetFacilityImagesResponse.images:type_name -> reservation.FacilityImage
	24,  // 120: reservation.ReservationService.CreateFacility:input_type -> reservation.CreateFacilityRequest
	26,  // 121: reservation.ReservationService.UpdateFacility:input_type -> reservation.UpdateFacilityRequest
	28,  // 122: reservation.ReservationService.ListFacilities:input_type -> reservation.ListFacilitiesRequest
	31,  // 123: reservation.ReservationService.CreateService:input_type -> reservation.CreateServiceRequest
	33,  // 124: reservation.ReservationService.UpdateService:input_type -> reservation.UpdateServiceRequest
	35,  // 125: reservation.ReservationService.ListServices:input_type -> reservation.ListServicesRequest
	38,  // 126: reservation.ReservationService.AssignServiceToProvider:input_type -> reservation.AssignServiceToProviderRequest
	40,  // 127: reservation.ReservationService.RemoveServiceFromProvider:input_type -> reservation.RemoveServiceFromProviderRequest
	44,  // 128: reservation.ReservationService.GetProviderServicesList:input_type -> reservation.GetProviderServicesListRequest
	42,  // 129: reservation.ReservationService.UpdateProviderService:input_type -> reservation.UpdateProviderServiceRequest
	47,  // 130: reservation.ReservationService.CreateWeeklySchedule:input_type -> reservation.CreateWeeklyScheduleRequest
	50,  // 131: reservation.ReservationService.GetWeeklyScheduleList:input_type -> reservation.GetWeeklyScheduleListRequest
	52,  // 132: reservation.ReservationService.UpdateWeeklySchedule:input_type -> reservation.UpdateWeeklyScheduleRequest
	54,  // 133: reservation.ReservationService.GenerateTimeSlots:input_type -> reservation.GenerateTimeSlotsRequest
	57,  // 134: reservation.ReservationService.GetTimeSlotsList:input_type -> reservation.GetTimeSlotsListRequest
	59,  // 135: reservation.ReservationService.UpdateTimeSlot:input_type -> reservation.UpdateTimeSlotRequest
	13,  // 136: reservation.ReservationService.AddFacilityImage:input_type -> reservation.FacilityImage
	109, // 137: reservation.ReservationService.DeleteFacilityImage:input_type -> reservation.DeleteFacilityImageRequest
	111, // 138: reservation.ReservationService.GetFacilityImages:input_type -> reservation.GetFacilityImagesRequest
	61,  // 139: reservation.ReservationService.CreateReservation:input_type -> reservation.CreateReservationRequest
	63,  // 140: reservation.ReservationService.CancelReservation:input_type -> reservation.CancelReservationRequest
	71,  // 141: reservation.ReservationService.UpdateReservationStatus:input_type -> reservation.UpdateReservationStatusRequest
	65,  // 142: reservation.ReservationService.MarkAttendance:input_type -> reservation.MarkAttendanceRequest
	67,  // 143: reservation.ReservationService.ListReservations:input_type -> reservation.ListReservationsRequest
	69,  // 144: reservation.ReservationService.ListAvailableTimeSlots:input_type -> reservation.ListAvailableTimeSlotsRequest
	73,  // 145: reservation.ReservationService.CreateProviderUnavailability:input_type -> reservation.CreateProviderUnavailabilityRequest
	75,  // 146: reservation.ReservationService.ListProviderUnavailability:input_type -> reservation.ListProviderUnavailabilityRequest
	77,  // 147: reservation.ReservationService.DeleteProviderUnavailability:input_type -> reservation.DeleteProviderUnavailabilityRequest
	79,  // 148: reservation.ReservationService.CreateRoomType:input_type -> reservation.CreateRoomTypeRequest
	81,  // 149: reservation.ReservationService.ListRoomTypes:input_type -> reservation.ListRoomTypesRequest
	83,  // 150: reservation.ReservationService.DeleteRoomType:input_type -> reservation.DeleteRoomTypeRequest
	85,  // 151: reservation.ReservationService.CreateRoom:input_type -> reservation.CreateRoomRequest
	87,  // 152: reservation.ReservationService.ListRooms:input_type -> reservation.ListRoomsRequest
	89,  // 153: reservation.ReservationService.DeleteRoom:input_type -> reservation.DeleteRoomRequest
	91,  // 154: reservation.ReservationService.AddRoomImage:input_type -> reservation.AddRoomImageRequest
	93,  // 155: reservation.ReservationService.GetRoomImages:input_type -> reservation.GetRoomImagesRequest
	95,  // 156: reservation.ReservationService.DeleteRoomImage:input_type -> reservation.DeleteRoomImageRequest
	97,  // 157: reservation.ReservationService.CheckRoomAvailability:input_type -> reservation.CheckRoomAvailabilityRequest
	99,  // 158: reservation.ReservationService.ListRoomAvailability:input_type -> reservation.ListRoomAvailabilityRequest
	101, // 159: reservation.ReservationService.CreateServiceUnavailability:input_type -> reservation.CreateServiceUnavailabilityRequest
	103, // 160: reservation.ReservationService.ListServiceUnavailability:input_type -> reservation.ListServiceUnavailabilityRequest
	105, // 161: reservation.ReservationService.DeleteServiceUnavailability:input_type -> reservation.DeleteServiceUnavailabilityRequest
	25,  // 162: reservation.ReservationService.CreateFacility:output_type -> reservation.CreateFacilityResponse
	27,  // 163: reservation.ReservationService.UpdateFacility:output_type -> reservation.UpdateFacilityResponse
	30,  // 164: reservation.ReservationService.ListFacilities:output_type -> reservation.ListFacilitiesResponse
	32,  // 165: reservation.ReservationService.CreateService:output_type -> reservation.CreateServiceResponse
	34,  // 166: reservation.ReservationService.UpdateService:output_type -> reservation.UpdateServiceResponse
	37,  // 167: reservation.ReservationService.ListServices:output_type -> reservation.ListServicesResponse
	39,  // 168: reservation.ReservationService.AssignServiceToProvider:output_type -> reservation.AssignServiceToProviderResponse
	41,  // 169: reservation.ReservationService.RemoveServiceFromProvider:output_type -> reservation.RemoveServiceFromProviderResponse
	46,  // 170: reservation.ReservationService.GetProviderServicesList:output_type -> reservation.GetProviderServicesListResponse
	43,  // 171: reservation.ReservationService.UpdateProviderService:output_type -> reservation.UpdateProviderServiceResponse
	48,  // 172: reservation.ReservationService.CreateWeeklySchedule:output_type -> reservation.CreateWeeklyScheduleResponse
	51,  // 173: reservation.ReservationService.GetWeeklyScheduleList:output_type -> reservation.GetWeeklyScheduleListResponse
	53,  // 174: reservation.ReservationService.UpdateWeeklySchedule:output_type -> reservation.UpdateWeeklyScheduleResponse
	55,  // 175: reservation.ReservationService.GenerateTimeSlots:output_type -> reservation.GenerateTimeSlotsResponse
	58,  // 176: reservation.ReservationService.GetTimeSlotsList:output_type -> reservation.GetTimeSlotsListResponse
	60,  // 177: reservation.ReservationService.UpdateTimeSlot:output_type -> reservation.UpdateTimeSlotResponse
	13,  // 178: reservation.ReservationService.AddFacilityImage:output_type -> reservation.FacilityImage
	110, // 179: reservation.ReservationService.DeleteFacilityImage:output_type -> reservation.DeleteFacilityImageResponse
	112, // 180: reservation.ReservationService.GetFacilityImages:output_type -> reservation.GetFacilityImagesResponse
	62,  // 181: reservation.ReservationService.CreateReservation:output_type -> reservation.CreateReservationResponse
	64,  // 182: reservation.ReservationService.CancelReservation:output_type -> reservation.CancelReservationResponse
	72,  // 183: reservation.ReservationService.UpdateReservationStatus:output_type -> reservation.UpdateReservationStatusResponse
	66,  // 184: reservation.ReservationService.MarkAttendance:output_type -> reservation.MarkAttendanceResponse
	68,  // 185: reservation.ReservationService.ListReservations:output_type -> reservation.ListReservationsResponse
	70,  // 186: reservation.ReservationService.ListAvailableTimeSlots:output_type -> reservation.ListAvailableTimeSlotsResponse
	74,  // 187: reservation.ReservationService.CreateProviderUnavailability:output_type -> reservation.CreateProviderUnavailabilityResponse
	76,  // 188: reservation.ReservationService.ListProviderUnavailability:output_type -> reservation.ListProviderUnavailabilityResponse
	78,  // 189: reservation.ReservationService.DeleteProviderUnavailability:output_type -> reservation.DeleteProviderUnavailabilityResponse
	80,  // 190: reservation.ReservationService.CreateRoomType:output_type -> reservation.CreateRoomTypeResponse
	82,  // 191: reservation.ReservationService.ListRoomTypes:output_type -> reservation.ListRoomTypesResponse
	84,  // 192: reservation.ReservationService.DeleteRoomType:output_type -> reservation.DeleteRoomTypeResponse
	86,  // 193: reservation.ReservationService.CreateRoom:output_type -> reservation.CreateRoomResponse
	88,  // 194: reservation.ReservationService.ListRooms:output_type -> reservation.ListRoomsResponse
	90,  // 195: reservation.ReservationService.DeleteRoom:output_type -> reservation.DeleteRoomResponse
	92,  // 196: reservation.ReservationService.AddRoomImage:output_type -> reservation.AddRoomImageResponse
	94,  // 197: reservation.ReservationService.GetRoomImages:output_type -> reservation.GetRoomImagesResponse
	96,  // 198: reservation.ReservationService.DeleteRoomImage:output_type -> reservation.DeleteRoomImageResponse
	98,  // 199: reservation.ReservationService.CheckRoomAvailability:output_type -> reservation.CheckRoomAvailabilityResponse
	100, // 200: reservation.ReservationService.ListRoomAvailability:output_type -> reservation.ListRoomAvailabilityResponse
	102, // 201: reservation.ReservationService.CreateServiceUnavailability:output_type -> reservation.CreateServiceUnavailabilityResponse
	104, // 202: reservation.ReservationService.ListServiceUnavailability:output_type -> reservation.ListServiceUnavailabilityResponse
	106, // 203: reservation.ReservationService.DeleteServiceUnavailability:output_type -> reservation.DeleteServiceUnavailabilityResponse
	162, // [162:204] is the sub-list for method output_type
	120, // [120:162] is the sub-list for method input_type
