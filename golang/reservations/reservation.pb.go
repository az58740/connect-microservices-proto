...
var file_reservations_reservation_proto_rawDesc = []byte{
	...
	0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07,
	0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x22, 0xc5, 0x01, 0x0a, 0x14, 0x57, 0x65, 0x65, 0x6b,
...
var file_reservations_reservation_proto_depIdxs = []int32{
	...
	8,   // 15: reservation.WeeklySchedule.status:type_name -> reservation.Status
	114, // 16: reservation.TimeSlot.start_time:type_name -> google.protobuf.Timestamp
	114, // 17: reservation.TimeSlot.end_time:type_name -> google.protobuf.Timestamp
	0,   // 18: reservation.TimeSlot.owner_type:type_name -> reservation.OwnerType
	9,   // 19: reservation.TimeSlot.source:type_name -> reservation.TimeSlot.SlotSource
	8,   // 20: reservation.TimeSlot.status:type_name -> reservation.Status
	114, // 21: reservation.ProviderUnavailability.date:type_name -> google.protobuf.Timestamp
	8,   // 22: reservation.ProviderUnavailability.status:type_name -> reservation.Status
	114, // 23: reservation.RoomAvailability.date:type_name -> google.protobuf.Timestamp
	114, // 24: reservation.ServiceUnavailability.from:type_name -> google.protobuf.Timestamp
	114, // 25: reservation.ServiceUnavailability.to:type_name -> google.protobuf.Timestamp
	...
	113, // 29: reservation.RoomType.base_price:type_name -> google.type.Money
	...
	1,   // 36: reservation.Reservation.status:type_name -> reservation.ReservationStatus
	114, // 37: reservation.Reservation.created_at:type_name -> google.protobuf.Timestamp
	10,  // 38: reservation.CreateFacilityRequest.name:type_name -> reservation.LocalizedString
	5,   // 39: reservation.CreateFacilityRequest.title:type_name -> reservation.FacilityTitle
	6,   // 40: reservation.CreateFacilityRequest.type:type_name -> reservation.FacilityType
	4,   // 41: reservation.CreateFacilityRequest.group:type_name -> reservation.FacilityGroup
	8,   // 42: reservation.CreateFacilityRequest.status:type_name -> reservation.Status
	11,  // 43: reservation.CreateFacilityResponse.facility:type_name -> reservation.Facility
	10,  // 44: reservation.UpdateFacilityRequest.name:type_name -> reservation.LocalizedString
	5,   // 45: reservation.UpdateFacilityRequest.title:type_name -> reservation.FacilityTitle
	6,   // 46: reservation.UpdateFacilityRequest.type:type_name -> reservation.FacilityType
	4,   // 47: reservation.UpdateFacilityRequest.group:type_name -> reservation.FacilityGroup
	8,   // 48: reservation.UpdateFacilityRequest.status:type_name -> reservation.Status
	11,  // 49: reservation.UpdateFacilityResponse.facility:type_name -> reservation.Facility
	29,  // 50: reservation.ListFacilitiesRequest.filter:type_name -> reservation.FaclityFilter
	4,   // 51: reservation.FaclityFilter.group:type_name -> reservation.FacilityGroup
	6,   // 52: reservation.FaclityFilter.type:type_name -> reservation.FacilityType
	5,   // 53: reservation.FaclityFilter.title:type_name -> reservation.FacilityTitle
	11,  // 54: reservation.ListFacilitiesResponse.facilities:type_name -> reservation.Facility
	10,  // 55: reservation.CreateServiceRequest.name:type_name -> reservation.LocalizedString
	10,  // 56: reservation.CreateServiceRequest.description:type_name -> reservation.LocalizedString
	113, // 57: reservation.CreateServiceRequest.default_price:type_name -> google.type.Money
	12,  // 58: reservation.CreateServiceResponse.service:type_name -> reservation.Service
	10,  // 59: reservation.UpdateServiceRequest.name:type_name -> reservation.LocalizedString
	10,  // 60: reservation.UpdateServiceRequest.description:type_name -> reservation.LocalizedString
	113, // 61: reservation.UpdateServiceRequest.default_price:type_name -> google.type.Money
	12,  // 62: reservation.UpdateServiceResponse.service:type_name -> reservation.Service
	36,  // 63: reservation.ListServicesRequest.filter:type_name -> reservation.ListServiceFilter
	12,  // 64: reservation.ListServicesResponse.services:type_name -> reservation.Service
	14,  // 65: reservation.AssignServiceToProviderRequest.services:type_name -> reservation.ProviderService
	14,  // 66: reservation.RemoveServiceFromProviderRequest.services:type_name -> reservation.ProviderService
	113, // 67: reservation.UpdateProviderServiceRequest.price:type_name -> google.type.Money
	14,  // 68: reservation.UpdateProviderServiceResponse.service:type_name -> reservation.ProviderService
	45,  // 69: reservation.GetProviderServicesListRequest.filter:type_name -> reservation.ProviderServiceFilter
	14,  // 70: reservation.GetProviderServicesListResponse.services:type_name -> reservation.ProviderService
	15,  // 71: reservation.CreateWeeklyScheduleRequest.schedule:type_name -> reservation.WeeklySchedule
	49,  // 72: reservation.GetWeeklyScheduleListRequest.filter:type_name -> reservation.WeeklyScheduleFilter
	15,  // 73: reservation.GetWeeklyScheduleListResponse.weeklyschedules:type_name -> reservation.WeeklySchedule
	2,   // 74: reservation.UpdateWeeklyScheduleRequest.day:type_name -> reservation.WeekDay
	8,   // 75: reservation.UpdateWeeklyScheduleRequest.status:type_name -> reservation.Status
	15,  // 76: reservation.UpdateWeeklyScheduleResponse.weeklySchedule:type_name -> reservation.WeeklySchedule
	16,  // 77: reservation.GenerateTimeSlotsRequest.timeslot:type_name -> reservation.TimeSlot
	114, // 78: reservation.TimeSlotsFilter.start_time:type_name -> google.protobuf.Timestamp
	114, // 79: reservation.TimeSlotsFilter.end_time:type_name -> google.protobuf.Timestamp
	0,   // 80: reservation.TimeSlotsFilter.owner_type:type_name -> reservation.OwnerType
	2,   // 81: reservation.TimeSlotsFilter.day:type_name -> reservation.WeekDay
	8,   // 82: reservation.TimeSlotsFilter.status:type_name -> reservation.Status
	56,  // 83: reservation.GetTimeSlotsListRequest.filter:type_name -> reservation.TimeSlotsFilter
	16,  // 84: reservation.GetTimeSlotsListResponse.stimeslots:type_name -> reservation.TimeSlot
	114, // 85: reservation.UpdateTimeSlotRequest.start_time:type_name -> google.protobuf.Timestamp
	114, // 86: reservation.UpdateTimeSlotRequest.end_time:type_name -> google.protobuf.Timestamp
	0,   // 87: reservation.UpdateTimeSlotRequest.owner_type:type_name -> reservation.OwnerType
	8,   // 88: reservation.UpdateTimeSlotRequest.status:type_name -> reservation.Status
	16,  // 89: reservation.UpdateTimeSlotResponse.tileslot:type_name -> reservation.TimeSlot
	3,   // 90: reservation.MarkAttendanceRequest.status:type_name -> reservation.AttendanceStatus
	23,  // 91: reservation.ListReservationsResponse.reservations:type_name -> reservation.Reservation
	114, // 92: reservation.ListAvailableTimeSlotsRequest.from:type_name -> google.protobuf.Timestamp
	114, // 93: reservation.ListAvailableTimeSlotsRequest.to:type_name -> google.protobuf.Timestamp
	16,  // 94: reservation.ListAvailableTimeSlotsResponse.time_slots:type_name -> reservation.TimeSlot
	1,   // 95: reservation.UpdateReservationStatusRequest.status:type_name -> reservation.ReservationStatus
	17,  // 96: reservation.CreateProviderUnavailabilityRequest.unavailability:type_name -> reservation.ProviderUnavailability
	114, // 97: reservation.ListProviderUnavailabilityRequest.from:type_name -> google.protobuf.Timestamp
	114, // 98: reservation.ListProviderUnavailabilityRequest.to:type_name -> google.protobuf.Timestamp
	17,  // 99: reservation.ListProviderUnavailabilityResponse.items:type_name -> reservation.ProviderUnavailability
	20,  // 100: reservation.CreateRoomTypeRequest.room_type:type_name -> reservation.RoomType
	20,  // 101: reservation.ListRoomTypesResponse.items:type_name -> reservation.RoomType
	21,  // 102: reservation.CreateRoomRequest.room:type_name -> reservation.Room
	21,  // 103: reservation.ListRoomsResponse.items:type_name -> reservation.Room
	22,  // 104: reservation.AddRoomImageRequest.image:type_name -> reservation.RoomImage
	22,  // 105: reservation.GetRoomImagesResponse.items:type_name -> reservation.RoomImage
	114, // 106: reservation.CheckRoomAvailabilityRequest.from:type_name -> google.protobuf.Timestamp
	114, // 107: reservation.CheckRoomAvailabilityRequest.to:type_name -> google.protobuf.Timestamp
	18,  // 108: reservation.CheckRoomAvailabilityResponse.items:type_name -> reservation.RoomAvailability
	114, // 109: reservation.ListRoomAvailabilityRequest.from:type_name -> google.protobuf.Timestamp
	114, // 110: reservation.ListRoomAvailabilityRequest.to:type_name -> google.protobuf.Timestamp
	18,  // 111: reservation.ListRoomAvailabilityResponse.items:type_name -> reservation.RoomAvailability
	19,  // 112: reservation.CreateServiceUnavailabilityRequest.unavailability:type_name -> reservation.ServiceUnavailability
	114, // 113: reservation.ListServiceUnavailabilityRequest.from:type_name -> google.protobuf.Timestamp
	114, // 114: reservation.ListServiceUnavailabilityRequest.to:type_name -> google.protobuf.Timestamp
	19,  // 115: reservation.ListServiceUnavailabilityResponse.items:type_name -> reservation.ServiceUnavailability
	13,  // 116: reservation.AddFacilityImageRequest.image:type_name -> reservation.FacilityImage
	13,  // 117: reservation.GetFacilityImagesResponse.images:type_name -> reservation.FacilityImage
	24,  // 118: reservation.ReservationService.CreateFacility:input_type -> reservation.CreateFacilityRequest
	26,  // 119: reservation.ReservationService.UpdateFacility:input_type -> reservation.UpdateFacilityRequest
	28,  // 120: reservation.ReservationService.ListFacilities:input_type -> reservation.ListFacilitiesRequest
	31,  // 121: reservation.ReservationService.CreateService:input_type -> reservation.CreateServiceRequest
	33,  // 122: reservation.ReservationService.UpdateService:input_type -> reservation.UpdateServiceRequest
	35,  // 123: reservation.ReservationService.ListServices:input_type -> reservation.ListServicesRequest
	38,  // 124: reservation.ReservationService.AssignServiceToProvider:input_type -> reservation.AssignServiceToProviderRequest
	40,  // 125: reservation.ReservationService.RemoveServiceFromProvider:input_type -> reservation.RemoveServiceFromProviderRequest
	44,  // 126: reservation.ReservationService.GetProviderServicesList:input_type -> reservation.GetProviderServicesListRequest
	42,  // 127: reservation.ReservationService.UpdateProviderService:input_type -> reservation.UpdateProviderServiceRequest
	47,  // 128: reservation.ReservationService.CreateWeeklySchedule:input_type -> reservation.CreateWeeklyScheduleRequest
	50,  // 129: reservation.ReservationService.GetWeeklyScheduleList:input_type -> reservation.GetWeeklyScheduleListRequest
	52,  // 130: reservation.ReservationService.UpdateWeeklySchedule:input_type -> reservation.UpdateWeeklyScheduleRequest
	54,  // 131: reservation.ReservationService.GenerateTimeSlots:input_type -> reservation.GenerateTimeSlotsRequest
	57,  // 132: reservation.ReservationService.GetTimeSlotsList:input_type -> reservation.GetTimeSlotsListRequest
	59,  // 133: reservation.ReservationService.UpdateTimeSlot:input_type -> reservation.UpdateTimeSlotRequest
	13,  // 134: reservation.ReservationService.AddFacilityImage:input_type -> reservation.FacilityImage
	109, // 135: reservation.ReservationService.DeleteFacilityImage:input_type -> reservation.DeleteFacilityImageRequest
	111, // 136: reservation.ReservationService.GetFacilityImages:input_type -> reservation.GetFacilityImagesRequest
	61,  // 137: reservation.ReservationService.CreateReservation:input_type -> reservation.CreateReservationRequest
	63,  // 138: reservation.ReservationService.CancelReservation:input_type -> reservation.CancelReservationRequest
	71,  // 139: reservation.ReservationService.UpdateReservationStatus:input_type -> reservation.UpdateReservationStatusRequest
	65,  // 140: reservation.ReservationService.MarkAttendance:input_type -> reservation.MarkAttendanceRequest
	67,  // 141: reservation.ReservationService.ListReservations:input_type -> reservation.ListReservationsRequest
	69,  // 142: reservation.ReservationService.ListAvailableTimeSlots:input_type -> reservation.ListAvailableTimeSlotsRequest
	73,  // 143: reservation.ReservationService.CreateProviderUnavailability:input_type -> reservation.CreateProviderUnavailabilityRequest
	75,  // 144: reservation.ReservationService.ListProviderUnavailability:input_type -> reservation.ListProviderUnavailabilityRequest
	77,  // 145: reservation.ReservationService.DeleteProviderUnavailability:input_type -> reservation.DeleteProviderUnavailabilityRequest
	79,  // 146: reservation.ReservationService.CreateRoomType:input_type -> reservation.CreateRoomTypeRequest
	81,  // 147: reservation.ReservationService.ListRoomTypes:input_type -> reservation.ListRoomTypesRequest
	83,  // 148: reservation.ReservationService.DeleteRoomType:input_type -> reservation.DeleteRoomTypeRequest
	85,  // 149: reservation.ReservationService.CreateRoom:input_type -> reservation.CreateRoomRequest
	87,  // 150: reservation.ReservationService.ListRooms:input_type -> reservation.ListRoomsRequest
	89,  // 151: reservation.ReservationService.DeleteRoom:input_type -> reservation.DeleteRoomRequest
	91,  // 152: reservation.ReservationService.AddRoomImage:input_type -> reservation.AddRoomImageRequest
	93,  // 153: reservation.ReservationService.GetRoomImages:input_type -> reservation.GetRoomImagesRequest
	95,  // 154: reservation.ReservationService.DeleteRoomImage:input_type -> reservation.DeleteRoomImageRequest
	97,  // 155: reservation.ReservationService.CheckRoomAvailability:input_type -> reservation.CheckRoomAvailabilityRequest
	99,  // 156: reservation.ReservationService.ListRoomAvailability:input_type -> reservation.ListRoomAvailabilityRequest
	101, // 157: reservation.ReservationService.CreateServiceUnavailability:input_type -> reservation.CreateServiceUnavailabilityRequest
	103, // 158: reservation.ReservationService.ListServiceUnavailability:input_type -> reservation.ListServiceUnavailabilityRequest
	105, // 159: reservation.ReservationService.DeleteServiceUnavailability:input_type -> reservation.DeleteServiceUnavailabilityRequest
	25,  // 160: reservation.ReservationService.CreateFacility:output_type -> reservation.CreateFacilityResponse
	27,  // 161: reservation.ReservationService.UpdateFacility:output_type -> reservation.UpdateFacilityResponse
	30,  // 162: reservation.ReservationService.ListFacilities:output_type -> reservation.ListFacilitiesResponse
	32,  // 163: reservation.ReservationService.CreateService:output_type -> reservation.CreateServiceResponse
	34,  // 164: reservation.ReservationService.UpdateService:output_type -> reservation.UpdateServiceResponse
	37,  // 165: reservation.ReservationService.ListServices:output_type -> reservation.ListServicesResponse
	39,  // 166: reservation.ReservationService.AssignServiceToProvider:output_type -> reservation.AssignServiceToProviderResponse
	41,  // 167: reservation.ReservationService.RemoveServiceFromProvider:output_type -> reservation.RemoveServiceFromProviderResponse
	46,  // 168: reservation.ReservationService.GetProviderServicesList:output_type -> reservation.GetProviderServicesListResponse
	43,  // 169: reservation.ReservationService.UpdateProviderService:output_type -> reservation.UpdateProviderServiceResponse
	48,  // 170: reservation.ReservationService.CreateWeeklySchedule:output_type -> reservation.CreateWeeklyScheduleResponse
	51,  // 171: reservation.ReservationService.GetWeeklyScheduleList:output_type -> reservation.GetWeeklyScheduleListResponse
	53,  // 172: reservation.ReservationService.UpdateWeeklySchedule:output_type -> reservation.UpdateWeeklyScheduleResponse
	55,  // 173: reservation.ReservationService.GenerateTimeSlots:output_type -> reservation.GenerateTimeSlotsResponse
	58,  // 174: reservation.ReservationService.GetTimeSlotsList:output_type -> reservation.GetTimeSlotsListResponse
	60,  // 175: reservation.ReservationService.UpdateTimeSlot:output_type -> reservation.UpdateTimeSlotResponse
	13,  // 176: reservation.ReservationService.AddFacilityImage:output_type -> reservation.FacilityImage
	110, // 177: reservation.ReservationService.DeleteFacilityImage:output_type -> reservation.DeleteFacilityImageResponse
	112, // 178: reservation.ReservationService.GetFacilityImages:output_type -> reservation.GetFacilityImagesResponse
	62,  // 179: reservation.ReservationService.CreateReservation:output_type -> reservation.CreateReservationResponse
	64,  // 180: reservation.ReservationService.CancelReservation:output_type -> reservation.CancelReservationResponse
	72,  // 181: reservation.ReservationService.UpdateReservationStatus:output_type -> reservation.UpdateReservationStatusResponse
	66,  // 182: reservation.ReservationService.MarkAttendance:output_type -> reservation.MarkAttendanceResponse
	68,  // 183: reservation.ReservationService.ListReservations:output_type -> reservation.ListReservationsResponse
	70,  // 184: reservation.ReservationService.ListAvailableTimeSlots:output_type -> reservation.ListAvailableTimeSlotsResponse
	74,  // 185: reservation.ReservationService.CreateProviderUnavailability:output_type -> reservation.CreateProviderUnavailabilityResponse
	76,  // 186: reservation.ReservationService.ListProviderUnavailability:output_type -> reservation.ListProviderUnavailabilityResponse
	78,  // 187: reservation.ReservationService.DeleteProviderUnavailability:output_type -> reservation.DeleteProviderUnavailabilityResponse
	80,  // 188: reservation.ReservationService.CreateRoomType:output_type -> reservation.CreateRoomTypeResponse
	82,  // 189: reservation.ReservationService.ListRoomTypes:output_type -> reservation.ListRoomTypesResponse
	84,  // 190: reservation.ReservationService.DeleteRoomType:output_type -> reservation.DeleteRoomTypeResponse
	86,  // 191: reservation.ReservationService.CreateRoom:output_type -> reservation.CreateRoomResponse
	88,  // 192: reservation.ReservationService.ListRooms:output_type -> reservation.ListRoomsResponse
	90,  // 193: reservation.ReservationService.DeleteRoom:output_type -> reservation.DeleteRoomResponse
	92,  // 194: reservation.ReservationService.AddRoomImage:output_type -> reservation.AddRoomImageResponse
	94,  // 195: reservation.ReservationService.GetRoomImages:output_type -> reservation.GetRoomImagesResponse
	96,  // 196: reservation.ReservationService.DeleteRoomImage:output_type -> reservation.DeleteRoomImageResponse
	98,  // 197: reservation.ReservationService.CheckRoomAvailability:output_type -> reservation.CheckRoomAvailabilityResponse
	100, // 198: reservation.ReservationService.ListRoomAvailability:output_type -> reservation.ListRoomAvailabilityResponse
	102, // 199: reservation.ReservationService.CreateServiceUnavailability:output_type -> reservation.CreateServiceUnavailabilityResponse
	104, // 200: reservation.ReservationService.ListServiceUnavailability:output_type -> reservation.ListServiceUnavailabilityResponse
	106, // 201: reservation.ReservationService.DeleteServiceUnavailability:output_type -> reservation.DeleteServiceUnavailabilityResponse
