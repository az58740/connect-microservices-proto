...
type User struct {
	...
	CreatedAt    *timestamppb.Timestamp `protobuf:"bytes,8,opt,name=created_at,json=createdAt,proto3" json:"created_at,omitempty"`          // Timestamp of when the user was created.
	UpdatedAt    *timestamppb.Timestamp `protobuf:"bytes,9,opt,name=updated_at,json=updatedAt,proto3" json:"updated_at,omitempty"`          // Timestamp of the last update to the user's record.
}
...
type Pagination struct {
	...
	SortBy         string `protobuf:"bytes,3,opt,name=sort_by,json=sortBy,proto3" json:"sort_by,omitempty"`                          // Field by which to sort the results (e.g., "username").
	SortDescending bool   `protobuf:"varint,4,opt,name=sort_descending,json=sortDescending,proto3" json:"sort_descending,omitempty"` // Whether to sort the results in descending order.
}
...
type UserFilter struct {
	...
	Password string   `protobuf:"bytes,3,opt,name=password,proto3" json:"password,omitempty"`              // Filter by password (not recommended for real-world use).
	Email    string   `protobuf:"bytes,4,opt,name=email,proto3" json:"email,omitempty"`                    // Filter by email address.
	RoleIds  []string `protobuf:"bytes,5,rep,name=role_ids,json=roleIds,proto3" json:"role_ids,omitempty"` // Filter by assigned role IDs.
}
...
var file_users_users_proto_rawDesc = []byte{
	...
	0x69, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x98, 0x01, 0x0a, 0x10, 0x43, 0x6f, 0x6e, 0x74, 0x72,
	...
	0x65, 0x12, 0x2e, 0x0a, 0x05, 0x67, 0x72, 0x6f, 0x75, 0x70, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b,
	...
	0x70, 0x22, 0x94, 0x02, 0x0a, 0x0b, 0x55, 0x73, 0x65, 0x72, 0x50, 0x72, 0x6f, 0x66, 0x69, 0x6c,
	...
	0x07, 0x7a, 0x69, 0x70, 0x43, 0x6f, 0x64, 0x65, 0x22, 0x8f, 0x03, 0x0a, 0x04, 0x55, 0x73, 0x65,
	...
	0x52, 0x6f, 0x6c, 0x65, 0x52, 0x05, 0x72, 0x6f, 0x6c, 0x65, 0x73, 0x12, 0x29, 0x0a, 0x06, 0x73,
	...
	0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x3b, 0x0a, 0x0c, 0x6f, 0x72, 0x67, 0x61, 0x6e, 0x69,
	0x7a, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x17, 0x2e, 0x75,
	...
	0x09, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x64, 0x41, 0x74, 0x22, 0x7f, 0x0a, 0x0a, 0x50, 0x61,
	...
	0x42, 0x79, 0x12, 0x27, 0x0a, 0x0f, 0x73, 0x6f, 0x72, 0x74, 0x5f, 0x64, 0x65, 0x73, 0x63, 0x65,
	0x6e, 0x64, 0x69, 0x6e, 0x67, 0x18, 0x04, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0e, 0x73, 0x6f, 0x72,
	0x74, 0x44, 0x65, 0x73, 0x63, 0x65, 0x6e, 0x64, 0x69, 0x6e, 0x67, 0x22, 0x8e, 0x01, 0x0a, 0x0a,
	0x55, 0x73, 0x65, 0x72, 0x46, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x12, 0x17, 0x0a, 0x07, 0x75, 0x73,
	...
	0x6c, 0x12, 0x19, 0x0a, 0x08, 0x72, 0x6f, 0x6c, 0x65, 0x5f, 0x69, 0x64, 0x73, 0x18, 0x05, 0x20,
	0x03, 0x28, 0x09, 0x52, 0x07, 0x72, 0x6f, 0x6c, 0x65, 0x49, 0x64, 0x73, 0x22, 0x39, 0x0a, 0x0a,
	0x52, 0x6f, 0x6c, 0x65, 0x46, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x12, 0x2b, 0x0a, 0x08, 0x72, 0x65,
	0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0f, 0x2e, 0x75,
	0x73, 0x65, 0x72, 0x73, 0x2e, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x52, 0x08, 0x72,
	0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x22, 0x95, 0x01, 0x0a, 0x0f, 0x52, 0x65, 0x67, 0x69,
	...
	0x63, 0x63, 0x65, 0x73, 0x73, 0x22, 0x29, 0x0a, 0x0e, 0x47, 0x65, 0x74, 0x55, 0x73, 0x65, 0x72,
	...
	0x6c, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x2a, 0x8f, 0x01, 0x0a, 0x0a, 0x55, 0x73, 0x65, 0x72, 0x53,
	...
	0x45, 0x4c, 0x45, 0x54, 0x45, 0x44, 0x10, 0x04, 0x32, 0xff, 0x02, 0x0a, 0x0c, 0x55, 0x73, 0x65,
	...
	0x73, 0x65, 0x12, 0x39, 0x0a, 0x0a, 0x4c, 0x6f, 0x67, 0x6f, 0x75, 0x74, 0x55, 0x73, 0x65, 0x72,
	0x12, 0x14, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x73, 0x2e, 0x4c, 0x6f, 0x67, 0x6f, 0x75, 0x74, 0x52,
	0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x15, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x73, 0x2e, 0x4c,
	...
	0x72, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x43, 0x5a, 0x41, 0x67, 0x69,
...
var file_users_users_proto_depIdxs = []int32{
	...
	23, // 7: users.User.created_at:type_name -> google.protobuf.Timestamp
	23, // 8: users.User.updated_at:type_name -> google.protobuf.Timestamp
	2,  // 9: users.RoleFilter.resource:type_name -> users.Resource
	7,  // 10: users.GetUserResponse.user:type_name -> users.User
	7,  // 11: users.UpdateUserRequest.user:type_name -> users.User
	8,  // 12: users.ListUsersRequest.pagination:type_name -> users.Pagination
	9,  // 13: users.ListUsersRequest.filter:type_name -> users.UserFilter
	7,  // 14: users.ListUsersResponse.users:type_name -> users.User
	11, // 15: users.UsersService.RegisterUser:input_type -> users.RegisterRequest
	13, // 16: users.UsersService.LoginUser:input_type -> users.LoginRequest
	15, // 17: users.UsersService.LogoutUser:input_type -> users.LogoutRequest
	17, // 18: users.UsersService.GetUser:input_type -> users.GetUserRequest
	19, // 19: users.UsersService.UpdateUser:input_type -> users.UpdateUserRequest
	21, // 20: users.UsersService.ListUsers:input_type -> users.ListUsersRequest
	12, // 21: users.UsersService.RegisterUser:output_type -> users.RegisterResponse
	14, // 22: users.UsersService.LoginUser:output_type -> users.LoginResponse
	16, // 23: users.UsersService.LogoutUser:output_type -> users.LogoutResponse
	18, // 24: users.UsersService.GetUser:output_type -> users.GetUserResponse
	20, // 25: users.UsersService.UpdateUser:output_type -> users.UpdateUserResponse
	22, // 26: users.UsersService.ListUsers:output_type -> users.ListUsersResponse
