...
var file_users_users_proto_rawDesc = []byte{
	...
	0x6e, 0x74, 0x72, 0x61, 0x63, 0x74, 0x46, 0x69, 0x6c, 0x65, 0x55, 0x72, 0x6c, 0x22, 0xfe, 0x02,
	...
	0x70, 0x52, 0x07, 0x65, 0x6e, 0x64, 0x44, 0x61, 0x74, 0x65, 0x12, 0x38, 0x0a, 0x09, 0x63, 0x72,
	...
	,
...
var file_users_users_proto_depIdxs = []int32{
	...
	58, // 34: users.ContractFilter.createdAt:type_name -> google.protobuf.Timestamp
	58, // 35: users.ContractFilter.updatedAt:type_name -> google.protobuf.Timestamp
	43, // 36: users.UpdateContractRequest.contract:type_name -> users.Contract
	44, // 37: users.ListContractRequest.filter:type_name -> users.ContractFilter
	12, // 38: users.ListContractRequest.pagination:type_name -> users.Pagination
	43, // 39: users.ListContractResponse.contracts:type_name -> users.Contract
	54, // 40: users.GetGeolocationRequest.filter:type_name -> users.GeolocationFilter
	53, // 41: users.GetGeolocationResponse.locations:type_name -> users.Geolocation
	5,  // 42: users.JobPost.status:type_name -> users.JobPostStatus
	58, // 43: users.JobPost.createdAt:type_name -> google.protobuf.Timestamp
	58, // 44: users.JobPost.updatedAt:type_name -> google.protobuf.Timestamp
	13, // 45: users.UsersService.RegisterUser:input_type -> users.RegisterRequest
	15, // 46: users.UsersService.LoginUser:input_type -> users.LoginRequest
	21, // 47: users.UsersService.ListUsers:input_type -> users.ListUsersRequest
	19, // 48: users.UsersService.UpdateUser:input_type -> users.UpdateUserRequest
	25, // 49: users.UsersService.CreateOrganizationGroup:input_type -> users.CreateOrganizationGroupRequest
	27, // 50: users.UsersService.UpdateOrganizationGroup:input_type -> users.UpdateOrganizationGroupRequest
	29, // 51: users.UsersService.DeleteOrganizationGroup:input_type -> users.DeleteOrganizationGroupRequest
	31, // 52: users.UsersService.ListOrganizationGroup:input_type -> users.ListOrganizationGroupRequest
	35, // 53: users.UsersService.CreateOrganization:input_type -> users.CreateOrganizationRequest
	37, // 54: users.UsersService.UpdateOrganization:input_type -> users.UpdateOrganizationRequest
	39, // 55: users.UsersService.DeleteOrganization:input_type -> users.DeleteOrganizationRequest
	41, // 56: users.UsersService.ListOrganization:input_type -> users.ListOrganizationRequest
	45, // 57: users.UsersService.CreateContract:input_type -> users.CreateContractRequest
	47, // 58: users.UsersService.UpdateContract:input_type -> users.UpdateContractRequest
	49, // 59: users.UsersService.DeleteContract:input_type -> users.DeleteContractRequest
	51, // 60: users.UsersService.ListContract:input_type -> users.ListContractRequest
	55, // 61: users.UsersService.GetCountries:input_type -> users.GetGeolocationRequest
	55, // 62: users.UsersService.GetProvinces:input_type -> users.GetGeolocationRequest
	55, // 63: users.UsersService.GetCities:input_type -> users.GetGeolocationRequest
	14, // 64: users.UsersService.RegisterUser:output_type -> users.RegisterResponse
	16, // 65: users.UsersService.LoginUser:output_type -> users.LoginResponse
	22, // 66: users.UsersService.ListUsers:output_type -> users.ListUsersResponse
	20, // 67: users.UsersService.UpdateUser:output_type -> users.UpdateUserResponse
	26, // 68: users.UsersService.CreateOrganizationGroup:output_type -> users.CreateOrganizationGroupResponse
	28, // 69: users.UsersService.UpdateOrganizationGroup:output_type -> users.UpdateOrganizationGroupResponse
	30, // 70: users.UsersService.DeleteOrganizationGroup:output_type -> users.DeleteOrganizationGroupResponse
	32, // 71: users.UsersService.ListOrganizationGroup:output_type -> users.ListOrganizationGroupResponse
	36, // 72: users.UsersService.CreateOrganization:output_type -> users.CreateOrganizationResponse
	38, // 73: users.UsersService.UpdateOrganization:output_type -> users.UpdateOrganizationResponse
	40, // 74: users.UsersService.DeleteOrganization:output_type -> users.DeleteOrganizationResponse
	42, // 75: users.UsersService.ListOrganization:output_type -> users.ListOrganizationResponse
	46, // 76: users.UsersService.CreateContract:output_type -> users.CreateContractResponse
	48, // 77: users.UsersService.UpdateContract:output_type -> users.UpdateContractResponse
	50, // 78: users.UsersService.DeleteContract:output_type -> users.DeleteContractResponse
	52, // 79: users.UsersService.ListContract:output_type -> users.ListContractResponse
	56, // 80: users.UsersService.GetCountries:output_type -> users.GetGeolocationResponse
	56, // 81: users.UsersService.GetProvinces:output_type -> users.GetGeolocationResponse
	56, // 82: users.UsersService.GetCities:output_type -> users.GetGeolocationResponse
