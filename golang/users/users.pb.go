...
type Permission struct {
	...
	PermissionName string `protobuf:"bytes,2,opt,name=permission_name,json=permissionName,proto3" json:"permission_name,omitempty"` // Name of the permission
}
...
type Role struct {
	...
	Permissions []*Permission `protobuf:"bytes,3,rep,name=permissions,proto3" json:"permissions,omitempty"`           // List of permissions associated with the role
}
...
type User struct {
	...
	Services     []*Service             `protobuf:"bytes,4,rep,name=services,proto3" json:"services,omitempty"`                             // Services the user has access to
	Status       UserStatus             `protobuf:"varint,5,opt,name=status,proto3,enum=users.UserStatus" json:"status,omitempty"`          // Current status of the user
	Organization *ContractingParty      `protobuf:"bytes,6,opt,name=organization,proto3" json:"organization,omitempty"`                     // Organization or contracting party
	Username     string                 `protobuf:"bytes,7,opt,name=username,proto3" json:"username,omitempty"`                             // Username (can be email)
	PasswordHash string                 `protobuf:"bytes,8,opt,name=password_hash,json=passwordHash,proto3" json:"password_hash,omitempty"` // Hash of the user's password (sensitive, avoid exposing in responses)
...
type ListUsersRequest struct {
	...
	PageSize  int32  `protobuf:"varint,1,opt,name=page_size,json=pageSize,proto3" json:"page_size,omitempty"`   // Number of users per page
	PageToken string `protobuf:"bytes,2,opt,name=page_token,json=pageToken,proto3" json:"page_token,omitempty"` // Token for pagination (optional)
}
...
type ListUsersResponse struct {
	...
	NextPageToken string  `protobuf:"bytes,2,opt,name=next_page_token,json=nextPageToken,proto3" json:"next_page_token,omitempty"` // Token for the next page (optional)
	TotalCount    int32   `protobuf:"varint,3,opt,name=total_count,json=totalCount,proto3" json:"total_count,omitempty"`           // Total number of users in the system
}
...
var file_users_users_proto_rawDesc = []byte{
	...
	0x76, 0x69, 0x63, 0x65, 0x4e, 0x61, 0x6d, 0x65, 0x22, 0x5a, 0x0a, 0x0a, 0x50, 0x65, 0x72, 0x6d,
	...
	0x4e, 0x61, 0x6d, 0x65, 0x22, 0x71, 0x0a, 0x04, 0x52, 0x6f, 0x6c, 0x65, 0x12, 0x17, 0x0a, 0x07,
	...
	0x6d, 0x65, 0x12, 0x33, 0x0a, 0x0b, 0x70, 0x65, 0x72, 0x6d, 0x69, 0x73, 0x73, 0x69, 0x6f, 0x6e,
	0x73, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x11, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x73, 0x2e,
	0x50, 0x65, 0x72, 0x6d, 0x69, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x52, 0x0b, 0x70, 0x65, 0x72, 0x6d,
	0x69, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x73, 0x22, 0x68, 0x0a, 0x10, 0x43, 0x6f, 0x6e, 0x74, 0x72,
	...
	0x65, 0x22, 0x94, 0x02, 0x0a, 0x0b, 0x55, 0x73, 0x65, 0x72, 0x50, 0x72, 0x6f, 0x66, 0x69, 0x6c,
	...
	0x79, 0x12, 0x24, 0x0a, 0x0e, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x5f, 0x6c, 0x69, 0x6e,
	0x65, 0x5f, 0x31, 0x18, 0x07, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0c, 0x61, 0x64, 0x64, 0x72, 0x65,
	0x73, 0x73, 0x4c, 0x69, 0x6e, 0x65, 0x31, 0x12, 0x24, 0x0a, 0x0e, 0x61, 0x64, 0x64, 0x72, 0x65,
	0x73, 0x73, 0x5f, 0x6c, 0x69, 0x6e, 0x65, 0x5f, 0x32, 0x18, 0x08, 0x20, 0x01, 0x28, 0x09, 0x52,
	...
	,
	...
	0x6f, 0x6e, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x17, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x73,
	...
	0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x5f, 0x68, 0x61, 0x73, 0x68, 0x18, 0x08, 0x20, 0x01,
	...
	0x61, 0x74, 0x65, 0x64, 0x41, 0x74, 0x22, 0x34, 0x0a, 0x11, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65,
	...
	0x73, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x52, 0x04, 0x75, 0x73, 0x65, 0x72, 0x22, 0x47, 0x0a, 0x12,
	...
	0x73, 0x73, 0x61, 0x67, 0x65, 0x22, 0x85, 0x01, 0x0a, 0x11, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65,
	...
	0x75, 0x73, 0x65, 0x72, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0b, 0x2e, 0x75, 0x73, 0x65,
	...
	0x52, 0x06, 0x75, 0x73, 0x65, 0x72, 0x49, 0x64, 0x22, 0x32, 0x0a, 0x0f, 0x47, 0x65, 0x74, 0x55,
	0x73, 0x65, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x1f, 0x0a, 0x04, 0x75,
	0x73, 0x65, 0x72, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0b, 0x2e, 0x75, 0x73, 0x65, 0x72,
	0x73, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x52, 0x04, 0x75, 0x73, 0x65, 0x72, 0x22, 0x4e, 0x0a, 0x10,
	...
	0x09, 0x52, 0x09, 0x70, 0x61, 0x67, 0x65, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x7f, 0x0a, 0x11,
	...
	0x05, 0x52, 0x0a, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x22, 0x2c, 0x0a,
	...
	0x28, 0x09, 0x52, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x2a, 0x8f, 0x01, 0x0a, 0x0a,
	...
	0x54, 0x55, 0x53, 0x5f, 0x44, 0x45, 0x4c, 0x45, 0x54, 0x45, 0x44, 0x10, 0x04, 0x32, 0xd1, 0x02,
...
var file_users_users_proto_goTypes = []any{
	...
	(*ListUsersRequest)(nil),      // 13: users.ListUsersRequest
	(*ListUsersResponse)(nil),     // 14: users.ListUsersResponse
...
var file_users_users_proto_depIdxs = []int32{
	2,  // 0: users.Role.permissions:type_name -> users.Permission
	5,  // 1: users.User.profile:type_name -> users.UserProfile
	3,  // 2: users.User.roles:type_name -> users.Role
	1,  // 3: users.User.services:type_name -> users.Service
	0,  // 4: users.User.status:type_name -> users.UserStatus
	4,  // 5: users.User.organization:type_name -> users.ContractingParty
	...
	6,  // 11: users.ListUsersResponse.users:type_name -> users.User
	...
	13, // 15: users.UsersService.ListUsers:input_type -> users.ListUsersRequest
	15, // 16: users.UsersService.DeleteUser:input_type -> users.DeleteUserRequest
	12, // 17: users.UsersService.GetUser:output_type -> users.GetUserResponse
	8,  // 18: users.UsersService.CreateUser:output_type -> users.CreateUserResponse
	10, // 19: users.UsersService.UpdateUser:output_type -> users.UpdateUserResponse
	14, // 20: users.UsersService.ListUsers:output_type -> users.ListUsersResponse
	16, // 21: users.UsersService.DeleteUser:output_type -> users.DeleteUserResponse
